# -*- coding: utf-8 -*-
"""
Created on Wed Mar  6 17:40:53 2019
    ...
    def detect_image(self, image, name):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if predicted_class == 'person':
                ...
                img = image_ori.crop((left, top, right, bottom))
                img.save('./output_none/{}_{}.jpg'.format(name,i))
...
if __name__ == '__main__':
    ...
    for imgfile in img_files:
        image = img_path + '/' + imgfile
        detect_img(yolo,image)
        
    yolo.close_session()
    #detect_video(yolo,0,'./output_run.mp4')
