# -*- coding: utf-8 -*-
"""
Created on Thu Mar  7 17:23:22 2019
...
if __name__ == '__main__':
    ...
    #得到数据
    train_generator = transfer.DataGen('./train2', image_size, image_size, batch_size, True)
    validation_generator = transfer.DataGen('./val2', image_size, image_size, batch_size, False)
